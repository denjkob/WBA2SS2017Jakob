...
app.post("/user", bodyParser.json(), function(req, res) {
  ...
  request(options, function(error, response, body) {
    getConsoleOut(error, req, response, body);
    bayeux.getClient().publish("/messages/new", {
        text: "Ein neuer User Eintrag wurde angelegt."
      })
      .then(function() {
...
app.post("/equipment", bodyParser.json(), function(req, res) {
  ...
  request(options, function(error, response, body) {
    getConsoleOut(error, req, response, body);
    bayeux.getClient().publish("/messages/new", {
        text: "Ein neuer Equipment Eintrag wurde angelegt."
      })
      .then(function() {
        console.log("faye: Nachricht geschickt!");
      }, function(error) {
...
app.post("/html/register", bodyParser.urlencoded({
  extended: true
}), function(req, res) {
  var url = dUrl + req.path;
...
app.put("/equipment/:id", bodyParser.json(), function(req, res) {
  ...
  request(options, function(error, response, body) {
    getConsoleOut(error, req, response, body);
    bayeux.getClient().publish("/messages/changes", {
        text: "UserID " + req.params.id + " wurde geändert."
      })
      .then(function() {
        console.log("faye: Nachricht geschickt!");
      }, function(error) {
...
app.put("/equipment/:id/order", bodyParser.json(), function(req, res) {
  ...
  request(options, function(error, response, body) {
    getConsoleOut(error, req, response, body);
    if (req.query.userid != null && req.query.until != null) {
      bayeux.getClient().publish("/messages/orders", {
          text: "Auf EquipmentID " + req.params.id + " wurde eine Order plaziert von UserID " + req.query.userid + ", falls diese freigeben war."
        })
        .then(function() {
          console.log("faye: Nachricht geschickt!");
        }, function(error) {
      ...
      bayeux.getClient().publish("/messages/orders", {
          text: "EquipmentID " + req.params.id + " wurde freigegeben. Es können wieder Orders platziert werden."
        })
        .then(function() {
          console.log("faye: Nachricht geschickt!");
        }, function(error) {
...
app.delete("/user/:id", function(req, res) {
  ...
  request.delete(url, function(error, response, body) {
    ...
    getConsoleOut(error, req, response, body);
    bayeux.getClient().publish("/messages/delete", {
        text: "Ein User Delete Request wurde gesendet."
      })
      .then(function() {
        console.log("faye: Nachricht geschickt!");
      }, function(error) {
...
app.delete("/equipment/:id", function(req, res) {
  ...
  request.delete(url, function(error, response, body) {
    ...
    getConsoleOut(error, req, response, body);
    bayeux.getClient().publish("/messages/delete", {
        text: "Ein Equipment Delete Request wurde gesendet."
      })
      .then(function() {
        console.log("faye: Nachricht geschickt!");
      }, function(error) {
